...
void loadByFEN(board_t *board, char *FEN){
    ...
    while((row != 0) || (col != 8)){
        switch(*ptr){
            case 'p':
                board->playingfield[posToIdx(row, col)] = 3; ptr++; col++;  break;
            case 'n':
                board->playingfield[posToIdx(row, col)] = 5; ptr++; col++;break;
            case 'b':
                board->playingfield[posToIdx(row, col)] = 9; ptr++; col++;break;
            case 'r':
                board->playingfield[posToIdx(row, col)] = 17; ptr++; col++;break;
            case 'q':
                board->playingfield[posToIdx(row, col)] = 33; ptr++; col++;break;
            case 'k': 
                board->playingfield[posToIdx(row, col)] = 65; ptr++; col++;break;
            case 'P':
                board->playingfield[posToIdx(row, col)] = 2; ptr++; col++;break;
            case 'N':
                board->playingfield[posToIdx(row, col)] = 4; ptr++; col++;break;
            case 'B':
                board->playingfield[posToIdx(row, col)] = 8; ptr++; col++;break;
            case 'R':
                board->playingfield[posToIdx(row, col)] = 16; ptr++; col++;break;
            case 'Q':
                board->playingfield[posToIdx(row, col)] = 32; ptr++; col++;break;
            case 'K': 
                board->playingfield[posToIdx(row, col)] = 64; ptr++; col++;break;
            case '/':
                ptr++; row--; col=0; break;
            case '1':
                ptr ++; col += 1; break;
    ...
    switch(*ptr){
        case 'w':
            board->player = WHITE; break;
        case 'b':
            board->player = BLACK; break;
    }
    ...
    while(*ptr != ' '){
        switch(*ptr){
            case 'K': 
                ptr++; board->castlerights = board->castlerights | SHORTSIDEW; break;
            case 'k':
                ptr++; board->castlerights = board->castlerights | SHORTSIDEB; break;
            case 'Q': 
                ptr++; board->castlerights = board->castlerights | LONGSIDEW; break;
            case 'q': 
                ptr++; board->castlerights = board->castlerights | LONGSIDEB; break;
            case '-':
                ptr++; break;
        }
    }
