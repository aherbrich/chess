use super::tables::{SQUARE_BB, BISHOP_MASK, BISHOP_MAGIC, BISHOP_BITS, BISHOP_ATTACKS_BLOCKERS_CONSIDERED, ROOK_MASK, ROOK_MAGIC, ROOK_BITS, ROOK_ATTACKS_BLOCKERS_CONSIDERED};
