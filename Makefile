...
EXERCISE_SRC = src/board.c src/helpers.c src/prettyprint.c
...
$(BUILD_DIR)/tests/test_%: tests/test_%.c $(BUILD_DIR)/src/board.o $(BUILD_DIR)/src/helpers.o $(BUILD_DIR)/src/prettyprint.o
	@mkdir -p $(dir $@)
	$(CC) $(CC_FLAGS) -o$@ $^
