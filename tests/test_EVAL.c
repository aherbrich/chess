...
int main(){
    ...
    for(int i = 0; i < 1; i++){
        ...
        for(int i = 1; i <= maxdepth; i++){
            evaluation = alphaBetaWithTT(board, i, NEGINFINITY, INFINITY);
            printf("\nEval(%d):", i);
        ...
        //evaluation = alphaBetaWithTT(board, maxdepth, NEGINFINITY, INFINITY,maxdepth, &bestmove);
